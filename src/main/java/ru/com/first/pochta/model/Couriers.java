...
public class Couriers {
    ...
    private float rate; // тариф: дорогой / дешевый
    private float rating; // качество доставки
    //private String company; // Наименование  
    private float price_min; // минимальный груз для забора 
    private float price_max; // максимальный груз для забора
    ...
    public Couriers(String track, String address, String phone, String name, int indexfrom, int indexto, int indexnow, float price, float weight, int id_courier) {
/*         this.track = track;
...
*/
    ...
    public String toString() {
        return "Couriers [id=" + id + ", track=" + track + ", address=" + address + ", phone=" + phone
       + "]";
    }
